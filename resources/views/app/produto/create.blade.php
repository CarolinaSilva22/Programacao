...
<head>
    ...
    <body>
        ...
        <div class="shadow text-bg-info p-3 fs-3"><center>PRODUTOS-adicionar</center></div></br>
        ...
        <div style="width: 40%; margin-left:auto;margin-right: auto; ">
            ...
            @csrf                    
            <div class="mb-3">
                <input name="nome" value="{{old('nome')}}" type="text"  placeholder="nome:" class="form-control @error('nome') is-invalid @enderror">
                @error('nome') <div class="invalid-feedback">{{$message}}</div>@enderror</div>
            <div class="mb-3">
                <input name="preco" value="{{old('preco')}}" type="text"  placeholder="preço:" class="form-control @error('preco') is-invalid @enderror">
                @error('preco') <div class="invalid-feedback">{{$message}}</div>@enderror</div>
            <div class="mb-3">
                <input name="estoque_maximo" value="{{old('estoque_maximo')}}" type="text"  placeholder="estoque maximo:" class="form-control @error('estoque_maximo') is-invalid @enderror">
                @error('estoque_maximo') <div class="invalid-feedback">{{$message}}</div>@enderror</div>
            <div class="mb-3">
                <input name="estoque_minimo" value="{{old('estoque_minimo')}}" type="text"  placeholder="estoque minimo:" class="form-control @error('estoque_minimo') is-invalid @enderror">
                @error('estoque_minimo') <div class="invalid-feedback">{{$message}}</div>@enderror</div>
            <div class="mb-3">
                <input name="descricao" value="{{old('descricao')}}" type="text"  placeholder="descrição:" class="form-control @error('descricao') is-invalid @enderror">
