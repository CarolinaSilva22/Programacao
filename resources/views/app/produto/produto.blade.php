...
<head>
    ...
    <body>
        ...
        <div class="shadow text-bg-info p-3 fs-3"><center>PRODUTOS</center></div>
</br>
        ...
        <p> <a class="link-info link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" 
         href="{{ route('app.produto.create') }}">Novo</a></p>
        </div>
        ...
        @foreach($produtos as $produto)
            <tr>
                ...
                <td><a type="button" href="{{route('app.produto.show', ['produto'=> $produto->id])}}" class="btn btn-outline-secondary">Detalhes</a></td>
                <td><a type="button" href="{{route('app.produto.edit', $produto->id)}}" class="btn btn-outline-success">Edit</a></td>
                <td><a type="button" href="{{route('app.produto.destroy', $produto->id)}}" class="btn btn-outline-primary">Excluir</a></td>
            </tr>
            </tr>
        @endforeach
        </tbody>
